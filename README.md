...
### 🎯 Основные функции
- ✅ **Парсинг товаров** с Taobao, Tmall, Pinduoduo, Szwego, 1688 по ссылке
...
- ✅ **OCR и анализ текста на изображениях**: распознавание текста и таблиц, перевод, извлечение информации о материалах, составе, цветах
...
- ✅ **Административная панель** с веб-интерфейсом для управления настройками
- ✅ **Динамическая конфигурация** через базу данных без перезапуска

### 🛠️ Технические особенности
- 🔄 **Индикатор "печатает"** во время обработки
- 📊 **Автоматическая ротация логов** (100 МБ, 30 дней хранения)
- 🐳 **Docker-ready** с docker-compose
- 🔒 **Безопасность**: non-root пользователь, SSL сертификаты, JWT аутентификация
- 📝 **Подробное логирование** всех ошибок с централизованной системой
- ⚙️ **Гибкая конфигурация** через .env файл и веб-интерфейс админ-панели
- 📦 **Модульная структура** с четким разделением ответственности (src/)
- 🔄 **Система перезапуска** с автоматической проверкой статуса
- 🗄️ **PostgreSQL** для хранения данных и настроек
