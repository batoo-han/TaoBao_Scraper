...
### 💰 Оптимизация стоимости LLM (OpenAI)
- ✅ **single_pass режим**: меньше данных в модель, меньше токенов
- ✅ **лимит выходных токенов** через `OPENAI_MAX_OUTPUT_TOKENS`
- ✅ **компактный промпт** через `OPENAI_PROMPT_VARIANT=compact_v2`
...
- отправьте **ссылку на товар** с Taobao, Tmall, 1688 или Pinduoduo — получить полное описание
